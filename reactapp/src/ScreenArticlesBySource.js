...
function ScreenArticlesBySource(props) {
  ...
  useEffect(() => {
    const findArticles = async() => {
      const data = await fetch(`https://newsapi.org/v2/top-headlines?sources=${props.match.params.id}&apiKey=66a1f76cc965462e9337b6a01968e4fd`)
              ...
              {articleList.map((article,i) => (
                ...
                <Card
                  ...
                  actions={[
                      ...
                      <Icon type="like" key="ellipsis" onClick={()=> {likeArticle(article)}} />
                  ]}
                  >
